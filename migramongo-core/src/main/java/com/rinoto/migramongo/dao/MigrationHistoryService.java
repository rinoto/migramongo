...
public interface MigrationHistoryService {
	...
	/**
	 * Gets the last migration that was applied, by checking the
	 * <code>createdAt</code> field of the entries
	 * 
	...
	/**
	 * It changes the status of an existing <code>MigrationEntry</code> to
	 * {@link com.rinoto.migramongo.MigraMongoStatus.MigrationStatus#OK}
	 * 
	 * @param migrationEntry
	 *            entry to change
	...
	/**
	 * It changes the status of an existing <code>MigrationEntry</code> to
	 * {@link com.rinoto.migramongo.MigraMongoStatus.MigrationStatus#OK} and
	 * adds the <code>repaired=true</code> to the entry.
	 * 
	 * @param migrationEntry
	 *            entry to change
	 * @return migEntry just changed
	...
	/**
	 * It changes the status of an existing <code>MigrationEntry</code> to
	 * {@link com.rinoto.migramongo.MigraMongoStatus.MigrationStatus#ERROR}
	 * 
	 * @param migrationEntry
	 *            entry to change
	 * @param e
	...
	/**
	 * Inserts a new <code>MigrationEntry</code> with the information of the
	 * <code>MigrationInfo</code> parameter
	 * 
	 * @param migrationInfo
	 *            info to insert
	...
	/**
	 * It finds a <code>MigrationEntry</code> that matches the
	 * <code>fromVersion</code> and <code>toVersion</code> parameters
	 * 
	 * @param fromVersion
	 *            fromVersion param
	 * @param toVersion
	...
	/**
	 * Returns all the migration entries that have been applied, ordered by date
	 * asc.
	 * 
