...
public class MigraMongoJMXTest {
	...
	public void shouldReturnAppliedMigrations() {
		// given
		final List<MigrationEntry> entries = Arrays.asList(createMigrationEntry("3.0", "4.0"),
				createMigrationEntry("4.0", "5.0"));
		...
		// then
		final List<MigrationEntry> entriesRetrieved = new Gson().fromJson(history,
